...
<div class="flex items-center justify-end h-full pl-20">
<img src="/images/book-cover.png" class="h-4/5 rounded shadow-2xl" alt="Generative AI on Kubernetes Book Cover" style="filter: drop-shadow(0 25px 50px rgba(0, 0, 0, 0.5));" />
</div>
